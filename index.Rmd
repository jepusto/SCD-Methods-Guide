...
date: "`r format.Date(Sys.Date(), format = '%B %d, %Y')`"
...
```{r, include = FALSE}
library(knitr)
opts_chunk$set(echo = FALSE, fig.retina = 2)
```
...
```{r, out.width = "100%", fig.cap = "Approaches to synthesizing findings from single-case research"}
include_graphics("images/flowchart_SynthesizingResults.png")
```
