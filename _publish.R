...
i = 1
s = paste0('title: "Synthesis of Single-Case Designs (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('SCD-Methods-Guide', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book('SCD-Methods-Guide')
