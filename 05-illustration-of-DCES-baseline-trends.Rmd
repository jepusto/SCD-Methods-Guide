...
```{r Datchuk-raw-2016, out.width = "60%", fig.cap = "Multiple Probe Data Extracted from Datchuk (2016)"}
# Figure 5.1
knitr::include_graphics("images/Datchuk2016.png")
```

```{r Rodgers-raw-2021, out.width = "60%", fig.cap = "Multiple Baseline Data Extracted from Rodgers et al. (2021)"}
# Figure 5.2
...
```{r Datchuk-2016-excel, out.width = "75%", fig.cap = "Snapshot of Spreadsheet Containing Extracted Datchuk (2016) Data"}
# Figure 5.4
knitr::include_graphics("images/Datchuk2016_Danyell.png")
```
...
```{r Datchuk-2016-load, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Load Tab for Datchuk (2016)"}
# Figure 5.5
knitr::include_graphics("images/app.load_Datchuk2016.png")
```

```{r Datchuk-2016-inspect-data, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Data Tab within the Inspect Tab for Datchuk (2016)"}
# Figure 5.6
knitr::include_graphics("images/app.inspect.data_Datchuk2016.png")
```

```{r Datchuk-2016-inspect-graph, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Graph Display within the Inspect Tab for Datchuk (2016)"}
# Figure 5.7
...
```{r Datchuk-2016-model6, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model Tab Showing Model 6 Specification for Datchuk (2016)"}
# Figure 5.8
...
```{r Datchuk-2016-ES, out.width = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Effect size Tab Showing Model 6 Estimate for Datchuk (2016)"}
# Figure 5.9
...
```{r Datchuk-2016-model5, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 5 Specification for Datchuk (2016)"}
# Figure 5.10
...
```{r Rodgers-2021-model6, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 6 Specification for Rodgers (2021)"}
# Figure 5.11
...
```{r Rodgers-2021-model5, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 5 Specification for Rodgers (2021)"}
# Figure 5.12
