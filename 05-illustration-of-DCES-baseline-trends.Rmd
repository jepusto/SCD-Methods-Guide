...
```{r Datchuk-raw-2016, out.width = "75%", out.height = "75%", fig.cap = "Multiple Probe Data Extracted from Datchuk (2016)"}
# Figure 5.1
knitr::include_graphics("images/Datchuk2016.png")
```

```{r Rodgers-raw-2021, out.width = "75%", out.height = "75%", fig.cap = "Multiple Baseline Data Extracted from Rodgers et al. (2021)"}
# Figure 5.2
knitr::include_graphics("images/Rodgers2020.png")
```
...
```{r Datchuk-2016-Danyell, out.width = "75%", out.height = "75%", fig.cap = "Illustration of Treatment Effect 5 Observations into Treatment for Danyell (Datchuk, 2016)"}
# Figure 5.3
knitr::include_graphics("images/Datchuk2016_Danyell.png")
```
...
```{r Datchuk-2016-excel, out.width = "75%", out.height = "75%", fig.cap = "Snapshot of Spreadsheet Containing Extracted Datchuk (2016) Data"}
# Figure 5.4
knitr::include_graphics("images/Datchuk2016_Danyell.png")
```
...
```{r Datchuk-2016-load, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Load Tab for Datchuk (2016)"}
# Figure 5.5
knitr::include_graphics("images/app.load_Datchuk2016.png")
```

```{r Datchuk-2016-inspect-data, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Data Tab within the Inspect Tab for Datchuk (2016)"}
# Figure 5.6
knitr::include_graphics("images/app.inspect.data_Datchuk2016.png")
```

```{r Datchuk-2016-inspect-graph, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Graph Display within the Inspect Tab for Datchuk (2016)"}
# Figure 5.7
knitr::include_graphics("images/app.inspect.graph_Datchuk2016.png")
```
...
```{r Datchuk-2016-model6, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model Tab Showing Model 6 Specification for Datchuk (2016)"}
# Figure 5.8
knitr::include_graphics("images/app.model.model6_Datchuk2016.png")
```
...
```{r Datchuk-2016-ES, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Effect size Tab Showing Model 6 Estimate for Datchuk (2016)"}
# Figure 5.9
knitr::include_graphics("images/app.ES.model6_Datchuk2016.png")
```
...
```{r Datchuk-2016-model5, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 5 Specification for Datchuk (2016)"}
# Figure 5.10
knitr::include_graphics("images/app.model.model5_Datchuk2016.png")
```
...
```{r Rodgers-2021-model6, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 6 Specification for Rodgers (2021)"}
# Figure 5.11
knitr::include_graphics("images/app.model.model6_Rodgers2020.png")
```
...
```{r Rodgers-2021-model5, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 5 Specification for Rodgers (2021)"}
# Figure 5.12
knitr::include_graphics("images/app.model.model5_Rodgers2020.png")
```
...
```{r ES-est-chapter5, echo=FALSE}
table_5.1 <- data.frame(
  Study = c("Datchuk (2016)", "Rodgers et al. (2020)", 
            "Hebert et al. (2018)", "Fixed effect meta-analysis",
            "Datchuk (2016)", "Rodgers et al. (2020)", 
            "Hebert et al. (2018)", "Fixed effect meta-analysis"),
  `Effect Size Estimate` = c(1.48, 0.76, 0.62, 0.67, 1.41, 0.46, 0.62, 0.65),
  `Standard Error` = c(0.98, 0.74, 0.22, 0.21, 0.46, 0.40, 0.22, 0.18),
  `Inverse-variance Weight` = c("1.04 (4.4)", "1.82 (7.8)", "20.66 (87.8)", "25.53 (100)",
                                "2.44 (8.3)", "6.25 (21.3)", "20.66 (70.4)", "29.35 (100)")
)

knitr::kable(table_5.1, 
             align=c("l","c","c","c"),
             col.names = c("Study",
  ...
  kable_classic() %>% 
  pack_rows("Model 6", 1, 4) %>%
  pack_rows("Model 5", 5, 8)
```
