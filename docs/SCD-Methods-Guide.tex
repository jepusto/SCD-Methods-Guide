...
\urlstyle{same}
\hypersetup{
  pdftitle={Methods Guide for Effect Estimation and Synthesis of Single-Case Studies},
  hidelinks,
...
\chaptermark{Introduction to D-CES}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{images/raw_txt.file_BSP} \caption{Screenshot of Saved Tab Delimited Text File}\label{fig:txt-BSP}
\end{figure}

After converting and saving our dataset as a tab delimited text file, we are prepared to use the MultiSCED app (\url{http://34.251.13.245/MultiSCED/}). Figure @\ref(fig:MultiSCED-homepage) is a screenshot of the Home page for the MultiSCED app. At the top of the website, in the blue page header, there are several links to other pages on the website. In this header, the link \emph{Home} is highlighted with a darker background than the other links on the menu bar, indicating that we are on the \emph{Home} page. To access the MultiSCED application, we must navigate to the \emph{Input} section of the site, by clicking on the \emph{Input} link.

\begin{figure}
\includegraphics[width=0.6\linewidth]{images/multiSCED.homepage} \caption{Screenshot of the Website Navigation Menu and Home Page of the MultiSCED App}\label{fig:MultiSCED-homepage}
\end{figure}
...
\chaptermark{Illustration of MLM With Trends}
...
\begin{figure}
\includegraphics[width=0.6\linewidth]{images/Walker2007} \caption{Effect of Intervention on Correct Word Sequences (Walker et al., 2007)}\label{fig:Walker-2007}
\end{figure}

\begin{figure}
\includegraphics[width=0.6\linewidth]{images/Stotz2008} \caption{Effect of Intervention on Correct Word Sequences (Stotz et al., 2008)}\label{fig:Stotz-2008}
\end{figure}
