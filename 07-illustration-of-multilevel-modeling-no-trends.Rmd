...
```{r Gage-raw-2018, out.width = "60%", fig.cap = "Effect of Intervention on the Rate of Behavior Specific Praise (Gage et al., 2018)"}
# Figure 7.1
knitr::include_graphics("images/Gage2018.png")
```

```{r CollierMeek-raw-2017, out.width = "60%", fig.cap = "Effect of Intervention on the Rate of Behavior Specific Praise (Collier-Meek et al., 2017)"}
# Figure 7.2
knitr::include_graphics("images/CollierMeek2017.png")
```

```{r SalleseVannest-raw-2022, out.width = "60%", fig.cap = "Effect of Intervention on the Rate of Behavior Specific Praise (Sallese & Vannest, 2022)"}
# Figure 7.3
knitr::include_graphics("images/CollierMeek2017.png")
```

```{r Knochel-raw-2021, out.width = "60%", fig.cap = "Effect of Intervention on the Rate of Behavior Specific Praise (Knochel et al., 2021)"}
# Figure 7.4
knitr::include_graphics("images/Knochel2021.png")
```
...
```{r Knochel-Sacrament-2021, out.width = "60%", fig.cap = "Illustration of Treatment Effect for Sacrament (Knochel et al., 2021)"}
# Figure 7.5
knitr::include_graphics("images/Knochel2021_Sacrament.png")
```
...
```{r Excel-BSP, out.width = "60%", fig.cap = "Screenshot of the Original Excel Spreadsheet Containing the BSP Data"}
# Figure 7.6
knitr::include_graphics("images/excel_BSP.png")
```
...
```{r txt-BSP, out.width = "60%", fig.cap = "Screenshot of Saved Tab Delimited Text File"}
# Figure 7.7
knitr::include_graphics("images/raw_txt.file_BSP.png")
```
...
```{r MultiSCED-homepage, out.width = "60%", fig.cap = "Screenshot of the Website Navigation Menu and Home Page of the MultiSCED App"}
# Figure 7.8
...
```{r MultiSCED-input-variables-BSP, out.width = "60%", fig.cap = "Screenshot of the Variables Section on the Input Page of the MultiSCED App"}
# Figure 7.10
knitr::include_graphics("images/MultiSCED_input.variables_BSP.png")
```
...
```{r MultiSCED-input-datasummary-BSP, out.width = "60%", fig.cap = "Screenshot of the Data summary Section on the Input Page of the MultiSCED App"}
# Figure 7.11
knitr::include_graphics("images/MultiSCED_input.datasummary_BSP.png")
```
...
```{r MultiSCED-modelspec-BSP, out.width = "60%", fig.cap = "Screenshot of the Model Specification Section of the Model Page of the MultiSCED App"}
# Figure 7.12
knitr::include_graphics("images/MultiSCED_model.modelspec_BSP.png")
```
...
```{r MultiSCED-3level, out.width = "60%", fig.cap = "Screenshot of the Three-level analysis of the MultiSCED App"}
# Figure 7.13
knitr::include_graphics("images/MultiSCED_3level.png")
```
...
```{r ES-est-chapter7, echo=FALSE}
table_7.1 <- data.frame(
  Study = c("Original specification", 
            "Within-case heterogeneity + autocorrelation", 
            "Within-case heterogeneity + autocorrelation + diagonal covariance matrices"),
  ES = c(7.95, 7.94, 7.93),
  SE = c(3.41, 3.40, 3.38),
  LL = c(-2.92, -2.93, -2.87),
  UL = c(18.83, 18.81, 18.73)
)

knitr::kable(table_7.1, 
             align=c("l","c","c","c","c"),
             col.names = c("", "", "", "LL", "UL"),
             caption = "Estimates Obtained Across Model Variations") %>%
  # kable_classic() %>% 
  kable_paper("striped") %>%
  add_header_above(c("Model" = 1, "Effect Estimate" = 1, "SE" = 1, "95% CI" = 2))
```
