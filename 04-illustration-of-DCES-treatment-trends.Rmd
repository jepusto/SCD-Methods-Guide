...
```{r Delemere-2018-MAJ, out.width = "60%",  fig.cap = "Multiple Baseline Data for Martin, Alan, and John (Delemere \\& Dounavi, 2018)"}
# Figure 4.1
knitr::include_graphics("images/DelemereDounavi2018_MartinAllenJohn.png")
```

```{r Delemere-2018-NMT, out.width = "60%", fig.cap = "Multiple Baseline Data for Niahm, Mary, and Thomas (Delemere \\& Dounavi, 2018)"}
# Figure 4.2
knitr::include_graphics("images/DelemereDounavi2018_NiahmMaryThomas.png")
```

```{r Gunning-2003, out.width = "60%", fig.cap = "Multiple Baseline Design Data from 7 Participants with the Target Outcome of Reducing Sleep Onset Latency (Gunning \\& Espie, 2003)"}
# Figure 4.3
...
```{r Delemere-2018-Martin, out.width = "75%", fig.cap = "Martin's Treatment Effect Five Observations into Treatment (Delemere \\& Dounavi, 2018)"}
# Figure 4.4
...
```{r Gunning-2003-excel, out.width = "60%", fig.cap = "Snapshot of Spreadsheet Containing Extracted Gunning \\& Espie (2003) Data"}
# Figure 4.5
...
```{r Gunning-2003-load, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Load Tab for Gunning \\& Espie (2003)"}
# Figure 4.6
...
```{r Gunning-2003-inspect-data, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Data Tab within the Inspect Tab for Gunning \\& Espie (2003)"}
# Figure 4.7
knitr::include_graphics("images/app.inspect.data_GunningEspie2003.png")
```

```{r Gunning-2003-inspect-graph, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Graph Display within the Inspect Tab for Gunning \\& Espie (2003)"}
# Figure 4.8
...
```{r Gunning-2003-model, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 4 Specification for Gunning \\& Espie (2003)"}
# Figure 4.9
...
```{r Gunning-2003-ES, out.width = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Effect size Tab Showing Model 4 Estimate for Gunning \\& Espie (2003)"}
...
```{r Delemere-model4, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 4 Specification for Delemere and Dounavi (2018)"}
# Figure 4.11
...
```{r Delemere-model3, out.width = "60%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 3 Specification for Delemere and Dounavi (2018)"}
# Figure 4.12
