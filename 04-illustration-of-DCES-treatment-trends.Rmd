...
```{r Delemere-2018-MAJ, out.width = "75%", out.height = "75%", fig.cap = "Multiple Baseline Data for Martin, Alan, and John (Delemere & Dounavi, 2018)"}
# Figure 4.1
knitr::include_graphics("images/DelemereDounavi2018_MartinAllenJohn.png")
```

```{r Delemere-2018-NMT, out.width = "75%", out.height = "75%", fig.cap = "Multiple Baseline Data for Niahm, Mary, and Thomas (Delemere & Dounavi, 2018)"}
# Figure 4.2
knitr::include_graphics("images/DelemereDounavi2018_NiahmMaryThomas.png")
```

```{r Gunning-2003, out.width = "75%", out.height = "75%", fig.cap = "Multiple Baseline Design Data from 7 Participants with the Target Outcome of Reducing Sleep Onset Latency (Gunning & Espie, 2003)"}
# Figure 4.3
knitr::include_graphics("images/Gunning&Espie2003.png")
```
...
```{r Delemere-2018-Martin, out.width = "75%", out.height = "75%", fig.cap = "Martin's Treatment Effect Five Observations into Treatment (Delemere & Dounavi, 2018)"}
# Figure 4.4
knitr::include_graphics("images/DelemereDounavi2018_Martin.png")
```
...
```{r Gunning-2003-excel, out.width = "75%", out.height = "75%", fig.cap = "Snapshot of Spreadsheet Containing Extracted Gunning & Espie (2003) Data"}
# Figure 4.5
knitr::include_graphics("images/excel_GunningEspie2003.png")
```
...
```{r Gunning-2003-load, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Load Tab for Gunning & Espie (2003)"}
# Figure 4.6
knitr::include_graphics("images/app.load_GunningEspie2003.png")
```
...
```{r Gunning-2003-inspect-data, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Data Tab within the Inspect Tab for Gunning & Espie (2003)"}
# Figure 4.7
knitr::include_graphics("images/app.inspect.data_GunningEspie2003.png")
```

```{r Gunning-2003-inspect-graph, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Graph Display within the Inspect Tab for Gunning & Espie (2003)"}
# Figure 4.8
knitr::include_graphics("images/app.inspect.graph_GunningEspie2003.png")
```
...
```{r Gunning-2003-model, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 4 Specification for Gunning & Espie (2003)"}
# Figure 4.9
knitr::include_graphics("images/app.model.model4_GunningEspie2003.png")
```
...
```{r Gunning-2003-ES, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Effect size Tab Showing Model 4 Estimate for Gunning & Espie (2003)"}
# MC: I corrected the title of Figure 4.10.
# Figure 4.10
knitr::include_graphics("images/app.ES.model4_GunningEspie2003.png")
```
...
```{r Delemere-model4, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 4 Specification for Delemere and Dounavi (2018)"}
# Figure 4.11
knitr::include_graphics("images/app.model.model4_DelemereDounavi2018.png")
```
...
```{r Delemere-model3, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 3 Specification for Delemere and Dounavi (2018)"}
# Figure 4.12
knitr::include_graphics("images/app.model.model3_DelemereDounavi2018.png")
```
...
```{r ES-est-chapter4, echo=FALSE}
table_4.1 <- data.frame(
  Study = c("Gunning & Espie (2003)", "Delemere & Dounavi (2018)", 
            "Montgomery et al. (2004)", "Fixed effect meta-analysis",
            "Gunning & Espie (2003)", "Delemere & Dounavi (2018)", 
            "Montgomery et al. (2004)", "Fixed effect meta-analysis"),
  `Effect Size Estimate` = c(-1.12, -0.70, -1.52, -1.15, -1.10, -0.91, -1.52, -1.14),
  `Standard Error` = c(0.34, 0.33, 0.29, 0.18, 0.17, 0.28, 0.29, 0.13),
  `Inverse-variance Weight` = c("8.65 (29.1)", "9.18 (30.9)", "11.89 (40.0)", "29.72 (100)",
                                "34.60 (58.4)", "12.76 (21.5)", "11.89 (20.1)", "59.25 (100)")
)

knitr::kable(table_4.1, 
             align=c("l","c","c","c"),
             col.names = c("Study",
