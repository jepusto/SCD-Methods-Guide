...
```{r Case-1992, out.width = "50%", fig.cap = "Multiple Baseline Data Extracted from Case et al. (1992)"}
# Figure 3.1
knitr::include_graphics("images/Case1992.png")
```

```{r Peltier-2020, out.width = "50%", out.height = "75%", fig.cap = "Multiple Baseline Data Extracted from Peltier et al. (2020)"}
# Figure 3.2
knitr::include_graphics("images/Peltier2020.png")
```

```{r Lambert-2006, out.width = "50%", out.height = "75%", fig.cap = "Replicated ABAB Data Extracted from Lambert et al. (2006)"}
# Figure 3.3
...
```{r Excel-Case-1992, out.width = "50%", out.height = "75%", fig.cap = "Illustration of Treatment Effect for Asher (Peltier et al., 2020)"}
# Figure 3.5
...
```{r Load-Case-1992, out.width = "50%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Load Tab"}
# Figure 3.6
...
```{r Inspect-Case-1992, out.width = "50%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Data Tab within Inspect Tab for Case et al. (1992)"}
# Figure 3.7
...
```{r Model2-Case-1992, out.width = "50%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model Tab Showing Model 2 Specification for Case et al. (1992)"}
# Figure 3.9
...
```{r Model1-Case-1992, out.width = "50%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model Tab Showing Model 1 Specification for Case et al. (1992)"}
# Figure 3.11
...
```{r Model2-Peltier-2020, out.width = "50%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 2 Specification for Peltier et al. (2020)"}
# Figure 3.12
...
```{r Model2-Lambert-2006, out.width = "50%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 2 Specification for Lambert et al. (2006)"}
# Figure 3.13
