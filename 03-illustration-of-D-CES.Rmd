...
```{r Case-1992, out.width = "75%", out.height = "75%", fig.cap = "Multiple Baseline Data Extracted from Case et al. (1992)"}
# Figure 3.1
knitr::include_graphics("images/Case1992.png")
```

```{r Peltier-2020, out.width = "75%", out.height = "75%", fig.cap = "Multiple Baseline Data Extracted from Peltier et al. (2020)"}
# Figure 3.2
knitr::include_graphics("images/Peltier2020.png")
```

```{r Lambert-2006, out.width = "75%", out.height = "75%", fig.cap = "Replicated ABAB Data Extracted from Lambert et al. (2006)"}
# Figure 3.3
knitr::include_graphics("images/Lambert2006.png")
```
...
```{r Peltier-Asher-2020, out.width = "75%", fig.cap = "Illustration of Treatment Effect for Asher (Peltier et al., 2020)"}
# Figure 3.4
knitr::include_graphics("images/Peltier2020_Asher.png")
```
...
```{r Excel-Case-1992, out.width = "75%", out.height = "75%", fig.cap = "Illustration of Treatment Effect for Asher (Peltier et al., 2020)"}
# Figure 3.5
knitr::include_graphics("images/excel_Case1992.jpeg")
```
...
```{r Load-Case-1992, out.width = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Load Tab"}
# Figure 3.6
knitr::include_graphics("images/app.load_Case1992.jpeg")
```
...
```{r Inspect-Case-1992, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Data Tab within Inspect Tab for Case et al. (1992)"}
# Figure 3.7
knitr::include_graphics("images/app.inspect.data_Case1992.jpeg")
```

```{r Graph-Case-1992, out.width = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Graph Tab Within Inspect Tab for Case et al. (1992)"}
# Figure 3.8
knitr::include_graphics("images/app.inspect.graph_Case1992.jpeg")
```
...
```{r Model2-Case-1992, out.width = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model Tab Showing Model 2 Specification for Case et al. (1992)"}
# Figure 3.9
knitr::include_graphics("images/app.model.model2_Case1992.png")
```
...
```{r ES-Model2-Case-1992, out.width = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Effect size Tab Showing Model 2 Estimate for Case et al. (1992)"}
# Figure 3.10
knitr::include_graphics("images/app.ES.model2_Case1992.jpeg")
```
...
```{r Model1-Case-1992, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model Tab Showing Model 1 Specification for Case et al. (1992)"}
# Figure 3.11
knitr::include_graphics("images/app.model.model1_Case1992.png")
```
...
```{r Model2-Peltier-2020, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 2 Specification for Peltier et al. (2020)"}
# Figure 3.12
knitr::include_graphics("images/app.model.model2_Peltier2020.png")
```
...
```{r Model2-Lambert-2006, out.width = "75%", out.height = "75%", fig.cap = "Between-Case Standardized Mean Difference Estimator (scdhlm, v. 0.6.0) Model 2 Specification for Lambert et al. (2006)"}
# Figure 3.13
knitr::include_graphics("images/app.model.model2_Lambert2006.png")
```
...
```{r ES-est, echo=FALSE}
table_3.1 <- data.frame(
  Study = c("Case et al. (1992)", "Peltier et al. (2020)", "Lambert et al. (2006)", "Hutchinson (1993)", "Fixed effect meta-analysis"),
  `Effect Size Estimate` = c(2.57, 2.95, 6.37, 0.71, 3.28),
  `Standard Error` = c(0.45, 0.28, 0.39, 0.45, 0.19),
  `Inverse-variance Weight` = c("4.94 (16.9)", "12.76 (43.7)", "6.57 (22.5)", "4.94 (16.9)", "29.21 (100)")
)

knitr::kable(table_3.1, 
             align=c("l","c","c","c"),
             col.names = c("Study",
                           "Effect Size Estimate (A)",
                           "Standard Error (B)",
                           "Inverse-variance Weight (%) (C)"),
             caption = "Fixed Effect Meta-Analysis Calculations for 
